    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline">
        <a-row :gutter="48">
          ...
          <a-col :md="8" :sm="24">
            <a-form-item label="请输入巡查人员">
              <a-input v-model="queryParam.person" placeholder="" />
            </a-form-item>
          </a-col> -->
          <a-col :md="8" :sm="24">
            <a-form-item label="请输入河道名称">
...
export default {
  ...
  data() {
    return {
      ...
      loadData: parameter => {
        return this.GetInspectDataList(
  ...
  methods: {
    ...mapActions('app', ['GetInspectDataList']),
